    ...
    with st.chat_message("assistant", avatar="🦖"):
        ...
        if room_info:
            ...
            try:
                ...
                full_context = f"""
                คุณคือรุ่นพี่ มก.ศรช. ที่เก่งเรื่องการอ่านระเบียบการ
                
                คำสั่ง:
                1. ค้นหาข้อมูลจาก [Knowledge Base] ด้านล่างนี้ โดยเฉพาะในส่วนที่เป็น 'ข้อมูลจากไฟล์ PDF'
                2. หากน้องถามเรื่อง 'ค่าเทอม' หรือ 'ค่าเรียน' ให้ค้นหาในตารางของไฟล์ 'อัตราค่าธรรมเนียมค่าเทอมทุกสาขาวิชา.pdf' อย่างละเอียด 
                3. คณะวิทยาศาสตร์ ศรีราชา (คณะวิทย์) มีค่าธรรมเนียมเหมาจ่ายรวม 34,900 บาท 
                4. สรุปข้อมูลให้ชัดเจน แบ่งเป็น ภาคปกติ, Summer และ สหกิจ 
