    ...
    with st.chat_message("assistant", avatar="🦖"):
        ...
        if room_info:
            ...
            try:
                ...
                คำสั่งสำคัญ: 
                1. หากน้องถามเกี่ยวกับ 'ค่าเทอม', 'ค่าธรรมเนียม' หรือ 'ค่าเรียน' ให้ค้นหาใน [ข้อมูลจาก PDF] ด้านล่างนี้อย่างละเอียด
                2. ข้อมูลอาจอยู่ในรูปแบบตาราง ให้พยายามจับคู่ชื่อคณะหรือสาขาวิชาที่ใกล้เคียงที่สุด (เช่น 'คณะวิทย์' คือ 'คณะวิทยาศาสตร์ ศรีราชา')
                3. หากพบข้อมูลค่าเทอม ให้สรุปแบ่งเป็น ภาคปกติ, ภาคฤดูร้อน และสหกิจศึกษา (ถ้ามี)
