...
# --- 3. CSS ปรับสี Sidebar และตัวอักษรขาว ---
st.markdown("""
<style>
    /* พื้นหลังหน้าหลัก */
    .stApp { background-color: #FFFFFF; color: black; }
    
    /* Sidebar: เปลี่ยนเป็นสีเขียวตามรูปที่ส่งมา */
    [data-testid="stSidebar"] { 
        background-color: #006861 !important; /* สีเขียวหัวเป็ดตามรูป */
        background-image: none !important;
    }

    /* บังคับตัวอักษร ไอคอน และข้อความทั้งหมดใน Sidebar ให้เป็นสีขาว */
    [data-testid="stSidebar"] *, 
    [data-testid="stSidebar"] .stMarkdown p, 
    [data-testid="stSidebar"] span, 
    [data-testid="stSidebar"] label,
    [data-testid="stSidebar"] .st-emotion-cache-1629ce8 p {
    ...
    /* กล่องขาวรายการแบบฟอร์ม (คงความขาวเพื่อให้เหมือนเรฟเฟอเรนซ์ในส่วนเนื้อหา) */
    ...
    /* ตัวหนังสือในกล่องขาวต้องเป็นสีดำเพื่อให้อ่านออก */
    .form-row {
        display: flex;
    ...
    .form-label {
        color: #333333 !important; /* ข้อความในกล่องขาวเป็นสีเข้ม */
        font-size: 13px;
        font-weight: 600;
        flex: 1;
    }
    ...
    /* ปรับแต่ง Expander Header ใน Sidebar */
    .st-emotion-cache-p5mtransition {
        background-color: rgba(255, 255, 255, 0.1) !important; /* พื้นหลังโปร่งแสงนิดๆ */
...
with st.sidebar:
    ...
    st.markdown("### 🎓 AI KUSRC Dashboard")

    # 2. รายการแบบฟอร์มด่วน (กล่องภายในยังคงสีขาวตามเรฟเฟอเรนซ์เพื่อให้ใช้งานง่าย)
